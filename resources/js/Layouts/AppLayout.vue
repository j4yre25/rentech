            ...
            <aside class="w-64 bg-white border-r border-gray-200">
                <div class="p-4">
                    ...
                    <ul class="mt-4 space-y-2">
                        ...
                        <li>
                            <Link :href="route('orders.index')" class="block px-4 py-2 rounded hover:bg-gray-100"
                                :class="{ 'bg-gray-100': route().current('orders.index') }">
                            Orders
                            </Link>
                        </li>
                        <li>
                            <Link :href="route('products.index')" class="block px-4 py-2 rounded hover:bg-gray-100"
                                :class="{ 'bg-gray-100': route().current('products.index') }">
                            Products
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link :href="route('profile.show')" class="block px-4 py-2 rounded hover:bg-gray-100"
                                :class="{ 'bg-gray-100': route().current('profile.show') }">
                            Reports
                            </Link>
                        </li>
